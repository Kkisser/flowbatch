...
THIRD_PARTY_INSTRUCTION = (
    ...
    "фильмам и студиям («в стиле Пиксар» — нельзя, «cinematic 3D animated "
    "cartoon, glossy stylized surfaces» — можно).\n"
    "\n"
    "СРЕДУ И ТЕХНИКУ НЕ МЕНЯЙ: если сцена была трёхмерным мультфильмом, она "
    "им и остаётся. Убирать надо ИМЯ чужой студии, а не саму мультяшность — "
    "превращать мультфильм в live-action, фотореализм или «без стилизации» "
    "категорически нельзя, это ломает весь сериал.\n"
    "\n"
    "Не добавляй пояснений, преамбул и комментариев. "
    "Верни ТОЛЬКО переписанный промпт."
)
