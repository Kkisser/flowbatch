...
def main() -> int:
    ...
    new, what, used = r._soften_escalate(scene, {scene.strip()}, 0, 9, "policy")
    ...
    new2, _, used2 = r2._soften_escalate(scene, {scene.strip()}, 3, 9, "policy")
    ...
    new3, _, used3 = r3._soften_escalate(scene, {scene.strip()}, 0, 9, "policy")
    ...
    new4, _, used4 = r4._soften_escalate(
